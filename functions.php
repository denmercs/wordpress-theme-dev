<?php
    ...
    function followandrew_register_scripts() {
        $version = wp_get_theme()->get('Version');
        wp_enqueue_script('followandrew-jquery', 'https://code.jquery.com/jquery-3.4.1.slim.min.js', array(), '3.4.1', 'all');
        ...
        wp_enqueue_script('followandrew-main', get_template_directory_uri() . '/assets/js/main.js', array(), $version, 'all');
    }
